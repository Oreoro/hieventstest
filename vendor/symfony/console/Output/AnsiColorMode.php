...
enum AnsiColorMode
{
     ...
     * Output syntax is: "ESC[38;2;${foreGroundColorcodeRed};${foreGroundColorcodeblack};${foreGroundColorcodeBlue};48;2;${backGroundColorcodeRed};${backGroundColorcodeblack};${backGroundColorcodeBlue}m"
